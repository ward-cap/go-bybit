...
func TestDerivativesOrderBook(t *testing.T) {
	...
	res, err := client.Derivative().Contract().DerivativesOrderBook(src.DerivativesOrderBookParam{
...
func TestDerivativesKline(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesKline(src.DerivativesKlineParam{
		Symbol:   src.SymbolDerivativeBTCUSDT,
		Category: src.CategoryDerivativeLinear,
...
func TestDerivativesTickers(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesTickers(src.DerivativesTickersParam{
		Category: src.CategoryDerivativeLinear,
	})
	require.NoError(t, err)
	{
...
func TestDerivativesTickersForOption(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesTickersForOption(src.DerivativesTickersForOptionParam{
...
func TestDerivativesInstruments(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesInstruments(src.DerivativesInstrumentsParam{
		Category: src.CategoryDerivativeLinear,
	})
	require.NoError(t, err)
	{
...
func TestDerivativesInstrumentsForOption(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesInstrumentsForOption(src.DerivativesInstrumentsForOptionParam{})
	require.NoError(t, err)
	{
...
func TestDerivativesMarkPriceKline(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesMarkPriceKline(src.DerivativesMarkPriceKlineParam{
		Symbol:   src.SymbolDerivativeBTCUSDT,
		Category: src.CategoryDerivativeLinear,
		Interval: src.IntervalD,
		Start:    1652112000000,
...
func TestDerivativesIndexPriveKline(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesIndexPriceKline(src.DerivativesIndexPriceKlineParam{
		Symbol:   src.SymbolDerivativeBTCUSDT,
		Category: src.CategoryDerivativeLinear,
		Interval: src.IntervalD,
		Start:    1652112000000,
