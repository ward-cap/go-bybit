...
func TestDerivativesOrderBook(t *testing.T) {
	...
	res, err := client.Derivative().UnifiedMargin().DerivativesOrderBook(src.DerivativesOrderBookParam{
		Symbol:   src.SymbolDerivativeBTCUSDT,
		Category: src.CategoryDerivativeLinear,
	})
...
func TestDerivativesKline(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().UnifiedMargin().DerivativesKline(src.DerivativesKlineParam{
		Symbol:   src.SymbolDerivativeBTCUSDT,
		Category: src.CategoryDerivativeLinear,
...
func TestDerivativesTickers(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().UnifiedMargin().DerivativesTickers(src.DerivativesTickersParam{
		Category: src.CategoryDerivativeLinear,
	})
	require.NoError(t, err)
	{
...
func TestDerivativesTickersForOption(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().UnifiedMargin().DerivativesTickersForOption(src.DerivativesTickersForOptionParam{
		Symbol: src.SymbolDerivativeBTC31MAR23_40000C,
	})
	require.NoError(t, err)
	{
...
func TestDerivativesInstruments(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().UnifiedMargin().DerivativesInstruments(src.DerivativesInstrumentsParam{
		Category: src.CategoryDerivativeLinear,
	})
	require.NoError(t, err)
	{
...
func TestDerivativesInstrumentsForOption(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().UnifiedMargin().DerivativesInstrumentsForOption(src.DerivativesInstrumentsForOptionParam{})
	require.NoError(t, err)
	{
...
func TestDerivativesMarkPriceKline(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().UnifiedMargin().DerivativesMarkPriceKline(src.DerivativesMarkPriceKlineParam{
		Symbol:   src.SymbolDerivativeBTCUSDT,
		Category: src.CategoryDerivativeLinear,
		Interval: src.IntervalD,
		Start:    1652112000000,
...
func TestDerivativesIndexPriveKline(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().UnifiedMargin().DerivativesIndexPriceKline(src.DerivativesIndexPriceKlineParam{
		Symbol:   src.SymbolDerivativeBTCUSDT,
		Category: src.CategoryDerivativeLinear,
		Interval: src.IntervalD,
		Start:    1652112000000,
